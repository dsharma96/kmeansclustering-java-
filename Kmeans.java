...
public class Kmeans
{
    public static void main(String[]args) throws IOException
    {
        ...
        ArrayList<String[]> docs = new ArrayList<String[]>();	// storing the documents;empty array list
        ArrayList<String> filenames = new ArrayList<String>();	//array list for storing the filenames
        ArrayList<String> global = new ArrayList<String>();		//for storing the words
	...
	//getting files
		...
		//creating the buffer character input stream
	    ...
	    HashSet<Integer> rand = new HashSet<Integer>();	//creating a set which contains unique elemnts
	    ...
	    for(int init=0;init<100;init++)
		    ...
		    while(go)
				...
				//after placing all the docs in the cluster, compare the previous iteration clusters with current clusters
		    	step.clear();
